...
.aa-content-ticker {
  ...
  box-shadow: 0 12px 32px rgba(57, 43, 29, 0.08);
}

${darkScope('.aa-content-ticker')} {
  background: rgba(26, 31, 28, 0.76);
  box-shadow: 0 12px 32px rgba(0, 0, 0, 0.16);
}

.aa-content-ticker__label {
  display: inline-flex;
  align-items: center;
  min-height: 34px;
  padding: 0 12px;
...
.aa-content-ticker:focus-within .aa-content-ticker__track {
  animation-play-state: paused;
}

.aa-content-ticker__group {
  display: flex;
  align-items: center;
  gap: 12px;
  padding-right: 12px;
...
[dir='rtl'] .aa-content-ticker__group {
  padding-right: 0;
  padding-left: 12px;
}

.aa-content-ticker__item {
  display: inline-flex;
  align-items: center;
  gap: 9px;
...
${darkScope('.aa-content-ticker__item')} {
  background: rgba(35, 41, 38, 0.82);
}
...
${darkScope('.aa-content-ticker__item:focus-visible')} {
  background: rgba(42, 49, 46, 0.98);
}
...
@keyframes aa-content-ticker-scroll {
  to {
...
await writeFile(path.join(distDir, 'recipes.css'), recipesCss + contentTickerCss);
